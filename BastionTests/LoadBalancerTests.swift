...
//  composition, and the load-balancer selection policies. Adapted from AIStudio.
//
...
final class LoadBalancerTests: XCTestCase {
    ...
    func testNovaGatewayBackendType() {
        ...
        // Bastion's backend set: ollama, mlx, openRouter, novaGateway, auto.
        XCTAssertEqual(LLMBackendType.allCases.count, 5)
    }
}
