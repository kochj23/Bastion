...
//  Bastion
//
//  Copied VERBATIM from AIStudio (kochj23/AIStudio). The parsing/composition and
//  LoadBalancer logic is pure and network-free so it is shared unchanged across
//  Jordan Koch's apps.
//
